...
export const InningSection = ({ inning }: InningProps) => {
  return (
    <div className="mb-8">
      <h2 className="text-xl font-bold mb-4 text-white">{inning.header}</h2>
      
      <div className="space-y-6">
        <BattingTable battingData={inning.batting} />
        
        {/* Extras and Total */}
        <div className="bg-black border border-gray-700 p-4 rounded-lg space-y-2">
        ...
        <div className="bg-black border border-gray-700 p-4 rounded-lg">
          <h3 className="text-white font-bold mb-2">Fall of Wickets</h3>
          <p className="text-gray-300">{inning.fallOfWickets.join(', ')}</p>
        </div>
