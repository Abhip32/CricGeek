  ...
  <div className="animate-pulse">
    ...
    <div className="flex items-center justify-center gap-4 mb-6">
      <div className="flex items-center">
        <div className="w-12 h-12 bg-gray-600 rounded mr-2" />
    ...
    <div className="w-3/4 h-8 bg-gray-600 rounded mx-auto mb-4" />
    <div className="w-1/2 h-6 bg-gray-600 rounded mx-auto mb-4" />

    {/* Scores Section Skeleton */}
    <div className="space-y-6">
      {/* Batting Team Skeleton */}
      <div className="bg-gray-700 p-4 rounded-lg">
        <div className="w-40 h-6 bg-gray-600 rounded mb-2" />
        <div className="w-24 h-8 bg-gray-600 rounded mb-4" />
        <div className="w-48 h-6 bg-gray-600 rounded mb-2" />
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {[1, 2].map((index) => (
            <div key={index} className="bg-gray-600 p-3 rounded-md">
              {[1, 2, 3, 4, 5, 6, 7].map((item) => (
                <div key={item} className="w-full h-4 bg-gray-500 rounded mb-2" />
              ))}
            </div>
          ))}
        </div>
    ...
    <div className="mt-6 bg-gray-700 p-4 rounded-lg">
      <div className="w-32 h-6 bg-gray-600 rounded mb-2" />
      <div className="w-48 h-4 bg-gray-600 rounded mb-1" />
...
const MiniScoreCard = (data:any) => {
  ...
  if (!data.data) {
    return (
      <div className="pt-28 px-5 w-full mx-auto text-white bg-zinc-950  shadow-lg">
        <SkeletonLoader />
      </div>
    );
  }
  ...
  return (
    <div className="pt-28 pb-5 px-5 w-full mx-auto text-white bg-zinc-950 shadow-lg">
                ...
                <table className="w-full text-sm">
                  ...
                  <tbody>
                    {currentBatsmen.map((batsman:any, index:any) => (
                      <tr key={index} className={`${index % 2 === 0 ? 'bg-gray-600/50' : 'bg-gray-600/30'}`}>
